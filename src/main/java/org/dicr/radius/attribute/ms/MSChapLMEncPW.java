...
/**
 * MS-CHAP-LM-Enc-PW attribute
 * <P>
 * This Attribute contains the new Windows NT password encrypted with the old LAN Manager password hash. The encrypted
 ...
 * </P>
 * <P>
 * This Attribute is only used in Access-Request packets, in conjunction with the MS-CHAP-CPW-2 attribute. It should
 * only be included if an MS-CHAP-Error attribute was included in the immediately preceding Access-Reject packet, the
 * String field of the MS-CHAP-Error attribute indicated that the user password had expired, and the MS-CHAP version is
 * 2 or greater.
 * </P>
 * 
 ...
 * @version 070525
 */
public class MSChapLMEncPW extends OctetsAttribute {
	/** Serial ID */
